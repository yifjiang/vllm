...
_WARMUP_MEMORY_BUFFER_BUDGET_FRACTION = 0.10
...
def _warmup_memory_buffer(transient_peak_headroom: int, available_memory: int) -> int:
    ...
    return min(buffer, int(_WARMUP_MEMORY_BUFFER_BUDGET_FRACTION * available_memory))
...
def configure_kv_cache(
    ...
    if kv_cache_groups := scheduler_kv_cache_config.kv_cache_groups:
        ...
        cache_config.kv_cache_size_tokens = num_tokens
        cache_config.kv_cache_max_concurrency = max_concurrency
